...
public class LevoDoleCev extends Cev {
	...
	protected void drawUnutrasnjost(Graphics g) {
		...
		g.fillRect(a*1/4, a*1/4, a*1/2, a*3/4);
	}

	@Override
	protected void drawIvica(Graphics g) {
		int a = 75;
		g.drawLine(0, a*1/4, a*3/4, a*1/4);
		g.drawLine(a*3/4, a*1/4, a*3/4, a);
		g.drawLine(0, a*3/4, a*1/4, a*3/4);
		g.drawLine(a*1/4, a*3/4, a*1/4, a);	
	}
